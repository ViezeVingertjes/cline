...
export class Cline {
        ...
        async summarizeContext() {
                ...
                try {
                    ...
                    const summarySystemPrompt = "You are helping to summarize the conversation to reduce context length while maintaining essential information. Provide a concise summary focusing on the most important actions and decisions. Include only the essential context needed to continue the task effectively.";
                    ...
                    await this.say(
                        "text",
                        "Context has been summarized to reduce token usage. Essential information has been preserved."
                    );
                    ...
                    await this.say(
                        "error",
                        "Failed to summarize context. The conversation history remains unchanged."
                    );
                }
        }
